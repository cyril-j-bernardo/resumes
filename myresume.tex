...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{}{FirstName LastName}{ \urlstyle{same}\href{www.linkedin.com/in/firstnamelastname}{www.linkedin.com/in/firstnamelastname}\\
\href{mailto:firstname.lastname@gmail.com}{firstname.lastname@gmail.com}| 123.123.1234 
}
...
\subsection{Private University}
\descript{M.S. Mechanical Engineering}
\location{Expected May 2017 | Somehwere, NY \\ Cum. GPA: 3.47/4.0}
...
\location{Minor in Aerospace Engineering \\ Expected May 2017 | Somewhere, NY \\ Cum. GPA: 3.49/4.0}
\sectionsep
...
Fraternity Foundation Scholarship
\sectionsep
...
\runsubsection{NASA Space Center}
\descript{| Engineering Intern }
\location{Aug 2016 - Present | City, State}
...
\runsubsection{Startup}
\descript{| Applied Research Intern }
\location{Jun 2016 - Aug 2016 | City, State}
\begin{tightemize}
...
\location{Feb 2016 - May 2016 | City, State}
\begin{tightemize}
...
\runsubsection{Some School of Medicine}
\descript{| Project Contributor}
\location{Sep 2015 - May 2016 | City, State}
\begin{tightemize}
...
\runsubsection{University Lab}
\descript{| Graduate Researcher}
\location{Jan 2015 - Jun 2015 | City, State}
\begin{tightemize}
